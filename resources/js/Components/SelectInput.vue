<template>
  <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
    <select class="rounded-md block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600  focus:border-purple-400-purple dark:focus:shadow-outline-gray form-input"
